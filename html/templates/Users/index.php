        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('image_1') ?></th>
                    <th><?= $this->Paginator->sort('image_2') ?></th>
                    <th><?= $this->Paginator->sort('image_3') ?></th>
                    <th><?= $this->Paginator->sort('image_4') ?></th>
                    <th><?= $this->Paginator->sort('image_5') ?></th>
